...
dependencies {
    implementation(platform("com.google.firebase:firebase-bom:32.8.0")) // Add Firebase BOM
    implementation("com.google.firebase:firebase-database") // Add Firebase Database
